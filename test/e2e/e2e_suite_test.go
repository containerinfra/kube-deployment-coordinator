...
var (
	...
	projectImage = "ghcr.io/containerinfra/kube-deployment-coordinator:latest"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting kube-deployment-coordinator integration test suite\n")
